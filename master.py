...
#    svnurl = 'https://192.168.112.237/svn/pro/'
    username = 'otbuild'
    password = 'wowgm#23'
...
#    if not version:
#        if project == "dsync-heroes":
#            projecturl = svnurl + 'trunk/' + "apollo/" + project
#        else:
#            projecturl = svnurl + 'trunk/' + project
#    else:
#        projecturl = svnurl + project + '/releases/' + version
...
#    view_directory()
    buildproject('war3redeem','jar','mvn package -DskipTests','https://192.168.112.237/svn/pro/app-war3-redeem/releases/v1.0')
